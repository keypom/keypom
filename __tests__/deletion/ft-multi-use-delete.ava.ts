...
test('Underpay, Withdraw, Delete', async t => {
    ...
    const asset_data = [
        {
            assets: [ftAsset1, ftAsset2],
            uses: 1
        },
        {
            assets: [ftAsset2, ftAsset3],
            uses: 1
        },
        {
            assets: [ftAsset1, ftAsset3],
            uses: 1
        }
    ]
...
test('Overpay, Withdraw, Delete', async t => {
    ...
    await sendFTs(funder, "1000", keypomV3, ftContract1, dropId);
...
test('Create & Delete Empty Drop', async t => {
    ...
    const dropId = "create empty delete";
    const asset_data = [
        {
            assets: [ftAsset1, ftAsset2],
            uses: 1
