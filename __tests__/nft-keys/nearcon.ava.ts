...
test('Journey 1: New to NEAR Purchases & Attends Conference', async t => {
    ...
    await funder.call(keypom, 'create_drop', createDropArgs({pubKeys: ticketHolderKeys.publicKeys, passwords, root, wasmDirectory: `${require('path').resolve(__dirname, '..')}/ext-wasm/trial-accounts.wasm`}), {gas: '300000000000000'});
...
test('Journey 2: Crypto Native Purchases & Attends Conference', async t => {
    ...
    await funder.call(keypom, 'create_drop', createDropArgs({pubKeys: ticketHolderKeys.publicKeys, nftOwners: [funder.accountId], passwords, root, wasmDirectory: `${require('path').resolve(__dirname, '..')}/ext-wasm/trial-accounts.wasm`}), {gas: '300000000000000'});
...
test('Journey 3: New to NEAR Purchases & Sells on Secondary Marketplace', async t => {
    ...
    await funder.call(keypom, 'create_drop', createDropArgs({pubKeys: sellerKeys.publicKeys, passwords, root, wasmDirectory: `${require('path').resolve(__dirname, '..')}/ext-wasm/trial-accounts.wasm`}), {gas: '300000000000000'});
...
test('Journey 4: Crypto Native Purchases & Sells on Secondary Marketplace', async t => {
    ...
    await funder.call(keypom, 'create_drop', createDropArgs({pubKeys: sellerKeys.publicKeys, nftOwners: [funder.accountId], passwords, root, wasmDirectory: `${require('path').resolve(__dirname, '..')}/ext-wasm/trial-accounts.wasm`}), {gas: '300000000000000'});
...
test('NFT with Owner Transferred, approved, and revoked using Keypom', async t => {
    ...
    await funder.call(keypom, 'create_drop', createDropArgs({pubKeys: originalOwnerKeys.publicKeys, nftOwners: [funder.accountId], passwords, root, wasmDirectory: `${require('path').resolve(__dirname, '..')}/ext-wasm/trial-accounts.wasm`}), {gas: '300000000000000'});
